    ...
    Dialog(onDismissRequest = onDismiss) {
        Card(
            ...
            Column(
                ...
                Text(
                    text = stringResource(R.string.label_confirmation_logout),
                ...
                Text(
                    text = stringResource(R.string.message_confirmation_logout),
                    style = MaterialTheme.typography.bodySmall.copy(
                ...
                ButtonComponent(
                    text = stringResource(R.string.label_yes_logout)
                ) {
                    onConfirm()
                }
